...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const stored = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem('cb_token') : "TURBOPACK unreachable";
            if (!stored) {
                setLoading(false);
                return;
            }
            fetch('/api/auth/me', {
                ...
                "AuthProvider.useEffect": ()=>localStorage.removeItem('cb_token')
    ...
    const register = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[register]": async (username, displayName, password, color)=>{
    ...
    const logout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[logout]": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["disconnectSocket"])();
            setToken(null);
            setUser(null);
        }
    }["AuthProvider.useCallback[logout]"], []);
...
_s(AuthProvider, "AzcNgTmr8B5xif/rTwZYIW6NIkU=");
_c = AuthProvider;
const useAuth = ()=>{
    _s1();
...
"[project]/src/lib/theme.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_lib_e8bde6eb._.js.map